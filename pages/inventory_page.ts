...
export class InventoryPage {
  // pongo todo lo que contiene la pagina de inventario
  readonly page: Page;
  ...
  constructor(page: Page) {
    // incializo la pagina con los identificadores de los elementos
    this.page = page;
  ...
  async removeBoltTshirtFromCart(itemName: string) {
